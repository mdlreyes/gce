...
if __name__=="__main__":
    ...
    runmcmc('inflowconst', nsteps=15625, nwalkers=32, delay=False, reioniz=False, rampressure=False, nomgas0=False, inflow='const', outflow=None)
    runmcmc('inflowexp', nsteps=15625, nwalkers=32, delay=False, reioniz=False, rampressure=False, nomgas0=False, inflow='expdec', outflow=None)
    runmcmc('outflow', nsteps=15625, nwalkers=32, delay=False, reioniz=False, rampressure=False, nomgas0=False, inflow=None, outflow='test')
