...
if __name__ == "__main__":
    ...
    model, atomic = gce.runmodel(scl_test_bothba_ba, plot=True, title="Sculptor dSph", empirical=True, empiricalfit=True, feh_denom=True, delay=False) #, amr="plots/amr_test", sfh="plots/sfh_test")
