...
if __name__ == "__main__":
    ...
    model, atomic, aic_nomgas_test = gce.runmodel(scl_test_nomgas0, plot=False, title="Sculptor dSph", empirical=True, empiricalfit=True, feh_denom=True, delay=False, reioniz=False, mgenhance=False, nomgas0=True) #, amr="plots/amr_test", sfh="plots/sfh_test")
