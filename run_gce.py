...
if __name__ == "__main__":
    ...
    scl_test_dartba = [0.26174988, 0.34544631, 3.99654462, 0.73483801, 0.84318372, 4.48682282, 0.37443831, 1.36155503, 1.31440352, 0.15734356, 0.94618028]
    ...
    #model, atomic = gce.runmodel(scl_test_baeu, plot=True, title="Sculptor dSph (test)", empirical=True, empiricalfit=True, feh_denom=True) #, amr="plots/amr_test", sfh="plots/sfh_test")
